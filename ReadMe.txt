...
because it was compiled and built using gcc and MSYS2.

Many changes to the source code were needed to compile with Visual Studio:

In Visual Studio a 'long' is 32 bits and in GCC a long is 64 bits. The trick
...
Compile all the other source elements separately into a .obj or .dll file,
then include this .obj or .dll file when linking GP.
