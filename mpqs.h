...
typedef struct mpqs_handle {
  ...
  int64_t *candidates;          /* collects promising sieve subscripts */
  int64_t *relaprimes;          /* prime/exponent pairs in a relation */
  ...
  int64_t lp_bound;             /* cutoff for Large Primes */
  int64_t digit_size_kN;
